package com.example.btvn_uth // **KIỂM TRA LẠI: Thay bằng package name chính xác của project bạn**
...
// Import các Composable từ file BTVN_UTH.kt
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            BTVN_UTHTheme { // Sử dụng Theme của project
                Surface(
...
// Định nghĩa các Route cho Navigation (Giữ nguyên)
object Destinations {
